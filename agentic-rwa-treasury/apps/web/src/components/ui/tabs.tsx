...
export function TabsTab({ className, ...props }: ComponentProps<typeof Primitive.Tab>) { return <Primitive.Tab className={cn("relative z-10 flex-1 rounded-[0.4375rem] px-3 text-xs font-medium text-muted outline-none data-active:text-ink focus-visible:ring-2 focus-visible:ring-accent/20", className)} {...props} />; }
